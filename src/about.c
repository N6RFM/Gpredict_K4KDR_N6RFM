...
const gchar *authors[] = {
    ...
    "",
    "",
    "GPredict_K4KDR_N6RFM (this fork):",
    "K4KDR -- Alpha-5 catalog number support (NORAD ID >= 100000)",
    "N6RFM -- Alpha-5 support, rotor display timer fix, radio control",
    "        deadlock/reconnect fix, this fork",
    "Claude (Anthropic) -- debugging, root cause analysis, and patches",
    "",
    "Imagery:",
